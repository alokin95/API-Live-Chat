...
vue_cookies__WEBPACK_IMPORTED_MODULE_4___default.a.config('7d'); // set global cookie

vue_cookies__WEBPACK_IMPORTED_MODULE_4___default.a.set('theme', 'default');
vue_cookies__WEBPACK_IMPORTED_MODULE_4___default.a.set('hover-time', '1s');
